import SettingsSection from "@/components/JobSeekerPortal/SettingsSection";
import { ChevronRightIcon } from "lucide-react";
import { useState } from "react";
// import { useNavigate } from "react-router-dom";

const Settings = () => {
  const [tab] = useState("Account Settings");
  const sideTabs = [
    {
  ...
  return (
    <div className="container 2xl:max-w-[1600px] lg:max-w-[1400px] 2xl:!my-36 !my-16 space-y-6">
      <div className="flex justify-between gap-3 md:items-center">
        <h1 className="text-heading !font-[700] !text-[24px] 2xl:text-[35px]">
          Settings
        </h1>
      </div>
