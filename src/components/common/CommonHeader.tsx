...
const CommonHeader = ({title, bannerImg}: CommonHeaderProps) => {
  return (
   <>
    <section
    className={`hidden md:flex items-center justify-center bg-no-repeat bg-center bg-cover h-[65vh] 2xl:h-[500px] common-header`}
      style={{ backgroundImage: `url(${bannerImg})` }}
    >
        <h3 className="text-white header_text font-[600] text-[40px] 2xl:text-[60px]">{title}</h3>
    </section>
    <section
